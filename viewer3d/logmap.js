...
export default class Logmap {
    ...
    Parameters:
        ...
        backgroundColor (Color): The color to use as a background color for the scene
        size (int): Size of the sphere (in pixels, approximately. Default: 1/10 of the
                    width of the DOM element at creation time)
    */
    constructor(domElement, backgroundColor, size) {
        ...
        this._initScene(backgroundColor);
    }
    ...
    Parameters:
        ...
        mu (Quaternion): The destination orientation
        f (Quaternion): The starting orientation
    ...
    */
    render(renderer, mu, f, cameraOrientation) {
    ...
    _initScene(backgroundColor) {
        ...
        this.orthoScene.background = backgroundColor;
